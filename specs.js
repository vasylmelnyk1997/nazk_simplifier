...
*/
        ...
        ["step-data-8"]: {
            ["num"]: { id: 0, name: "№" },
            ["business_info"]: { id: 1, name: "загальна інформація про субʼєкта господарювання, дата набуття права" },
            ["ownership_amount"]: { id: 2, name: "вартість частки у грошовому вираженні, грн" },
            ["ownership_percentage"]: { id: 3, name: "частка у статутному (складеному) капіталі (% від загального капіталу)" },
            ["rights_transfer"]: { id: 4, name: "інформація про передачу корпоративних прав в управління" },
            ["owner_info"]: { id: 5, name: "інформація щодо особи, якій належить обʼєкт" },
        },
        ...
        ["step-data-9"]: {
            ...
            ["owner_info"]: { id: 3, name: "інформація щодо особи, якій належить обʼєкт" },
        },
        ...
        ["step-data-10"]: {
            ...
            ["value"]: { id: 3, name: "вартість на дату набуття права або за останньою грошовою оцінкою, грн" },
            ["owner_info"]: { id: 4, name: "інформація щодо особи, якій належить обʼєкт, і прав на нього" },
        },
        ...
        ["step-data-12"]: {
            ...
            ["owner_info"]: { id: 4, name: "інформація про особу, якій належить обʼєкт, і прав на нього" },
        },
